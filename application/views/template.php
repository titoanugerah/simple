      ...
      <div class="navbar-custom-menu">
        ...
        -->
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('./assets/dist/img/user2-160x160.jpg.png'); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->userdata['fullname']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url('./assets/dist/img/user2-160x160.jpg.png'); ?>" class="img-circle" alt="User Image">
