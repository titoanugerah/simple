        ...
        <div class="active tab-pane" id="createAccount">
          <form class="form-horizontal" method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Masukan nama panjang" name="fullname" value="">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Masukan Nomor HP" name="phone_number">
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" class="btn btn-success" name="createAccount" value="createAccount">Tambah Akun Pelanggan</button>
              </div>
            </div>
          </form>
        </div>
